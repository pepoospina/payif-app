...
import { createTestServices } from '../test/__tests__/test.services';
...
const mandatory = ['FB_CERT_PATH', 'FB_PROJECT_ID'];
...
export const services = createTestServices(app.firestore(), config);
